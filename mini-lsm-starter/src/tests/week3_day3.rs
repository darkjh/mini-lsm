...
// TODO should we also try exclude lower bound for memtable scan ???
// #[test]
// fn test_task2_memtable_mvcc_min() {
//     let dir = tempdir().unwrap();
//     let mut options = LsmStorageOptions::default_for_week2_test(CompactionOptions::NoCompaction);
//     options.enable_wal = true;
//     let storage = MiniLsm::open(&dir, options.clone()).unwrap();
//     storage.put(b"a", b"1").unwrap(); // 1
//     storage.put(b"b", b"1").unwrap(); // 2
//     storage.put(b"a", b"2").unwrap(); // 3
//     storage.delete(b"b").unwrap(); // 4
//     storage.put(b"c", b"1").unwrap(); // 5
//
//     let snapshot3 = storage.new_txn().unwrap(); // 3
//
//     {
//         let mut iter = snapshot3.scan(Bound::Excluded(b"a"), Bound::Excluded(b"c")).unwrap();
//         while iter.is_valid() {
//             println!(
//                 "k {} v {}",
...
//     //     &mut snapshot3.scan(Bound::Excluded(b"a"), Bound::Excluded(b"c")).unwrap(),
//     //     vec![],
//     // );
// }
